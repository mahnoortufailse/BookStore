...
const ContactUs = () => {
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-12 border">
        <div className="bg-black dark:bg-slate-900 md:col-span-4 p-10 text-white">
            ...
            <div className="flex items-center mt-5">
                <svg className="h-10 mr-2 text-pink-600" fill="currentColor" version="1.1"
            ...
            <div className="flex items-center mt-5">
                <svg className="h-6 mr-2 text-pink-600" fill="currentColor" version="1.1" id="Capa_1"
        ...
        <form className="md:col-span-8 p-10">
            <div className="flex flex-wrap -mx-3 mb-6">
                <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    <label className="block uppercase tracking-wide text-gray-700 text-s font-bold mb-2 dark:text-gray-500"
                ...
                <div className="w-full md:w-1/2 px-3">
                    <label className="block uppercase tracking-wide text-gray-700 text-s font-semibold mb-2 dark:text-gray-500"
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
                ...
                <div className="flex justify-between w-full px-3">
                    ...
                    <button
                        className="shadow bg-pink-600 hover:bg-pink-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-6 rounded"
                        type="submit">
                        Send Message
                    </button>
                </div>
